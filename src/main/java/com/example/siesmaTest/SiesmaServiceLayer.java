...
public class SiesmaServiceLayer {
    ...
    public void calculateEmployeeTax(ArrayList<Employee> emps){
        ...
        //    String pathM = SiesmaServiceLayer.class.getResource("/taxSlabs.json");
       //     siesmaBusinessLogicLayerObj.calculateTaxOfEmployee(emp, TaxSlabPOJO.serealizeTaxSlabs(pathM));
